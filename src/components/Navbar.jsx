...
import { Recycle, LogOut, Mail, Home, Info, Settings, ShoppingBasket } from 'lucide-react';
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary sticky-nav shadow-sm">
      <div className="container">
        ...
        <Link className="navbar-brand d-flex align-items-center text-white" to="/">
          <ShoppingBasket className="me-2" size={24} />
          <span className="fw-bold">EasyBuy</span>
        </Link>
